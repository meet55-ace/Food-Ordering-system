                ...
                <div class="carousel-item active">
                    <div class="single-item">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="content">
                                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloribus saepe expedita
                                        consequuntur iure pariatur praesentium, corporis eos quas, officia repudiandae
                                        molestias dolorum id.</p>
                                </div>
                                <div class="bio">
                                    <h2>Mansi</h2>
                                    <h4>Lapinoz</h4>
...
register_form.addEventListener('submit', function(e) {
    ...
    data.append('approx', register_form.elements['approx'].value);
    ...
    xhr.onload = function() {
        ...
        switch (responseText) {
            ...
            case '5':
                ...
                break;
            case '6':
                alert("Error in moving the uploaded file");
                break;
            case '6':
                alert("Error in moving the uploaded file");
                break;
    ...
    xhr.onload = function() {
        ...
        switch (responseText) {
            case '0':
                ...
                break;
            case '2':
                alert("Account Disabled ! Please contact Admin.");
                break;
            case '4':
            ...
            case '5':
                alert(
                    "Your account is not allowed to log in (pending or rejected). Please contact support."
                    );
                break;
            default:
