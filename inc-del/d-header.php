                ...
                <nav class="navbar navbar-expand-lg">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ms-auto gap-lg-4">
                            <li class="nav-item me-1"><a href="delivery.php" class="nav-link"><i class="fa-solid fa-house px-2"></i>Home</a> </li>
                            <li class="nav-item me-1"><a href="delivery_orders.php" class="nav-link"><i
